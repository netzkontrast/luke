/* Der Weltzustand.
   ...
   Bisher hatte jedes bewegte Ding auf dieser Seite seine eigene Buchhaltung: die
   Bewegungsebene liest die Scrollposition, die 3D-Sequenz las sie noch einmal, tropfspur.js ein
   ...
   läuft; auf der Werkschau steht sie in index.html vor den Skripten am Ende). Auf der
   Werkschau liest nur die Tropfspur den Weltzustand; alles andere läuft über Motion
   (js/bewegung.js). Ohne
...
(function () {
  ...
  /* Die Abschnitte einmal ausmessen. Das kostet Layout und passiert deshalb nur bei
     ...
     Abschnitte, die es nicht gibt oder die ausgeblendet sind (etwa „Aktuell" nach der Ausstellung),
