...
# Papierarbeiten immer aus assets/img/: Nur dort ist das Papier auf Weiß gezogen. Alle Blätter
# der Serie „Befreiung der Körperlichkeit“, Werk I und Werk II; welche Datei ein Werk nimmt,
# steht in src/werke.ts (Feld bilder).
cp ../assets/img/werk-befreiung-*.webp public/img/
